...
class Maps extends Component {
    ...
    render() {
        return (
            ...
            <React.Fragment>
            <a href="https://res.cloudinary.com/haikupirate/image/upload/v1574661151/haiku/Pirate_Final_Art_pwx5kk.pdf" target="_blank" style={{textAlign: "center", position: "absolute", right: "10px", top: "10px", zIndex: 999}}>
