...
class Maps extends Component {
    ...
    render() {
        return (
            ...
            <React.Fragment>
            <a href="https://res.cloudinary.com/haikupirate/image/upload/v1576978121/haiku/final_2_uktppd.pdf" target="_blank" style={{textAlign: "center", position: "absolute", right: "10px", top: "10px", zIndex: 999}}>
